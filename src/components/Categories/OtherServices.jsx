...
const OtherServices = () => {
  const Categories = [
    {
      id: 1,
      title: "Laptop Cleaning (Internal/External)",
      price: 1600,
      category: "Laptop Cleaning (Internal/External)",
      image: product1,
      text: "Expert Laptop Cleaning (Internal/External) services.",
      link: "/link",
    },
    {
      id: 2,
      title: "Dust and Heat Management",
      price: 2400,
      category: "Dust and Heat Management",
      image: product3,
    ...
    },
    {
      ...
      price: 2100,
      category: "Data Migration Services",
      image: product4,
              ...
              <div className="p-4 rounded" style={{ backgroundColor: '#f5f1f1' }}>
                ...
                <label className="d-flex align-items-center mb-3">
                  <input
                    ...
                    onChange={() =>
                      handleCategoryChange("Laptop Cleaning (Internal/External)")
                    }
                    className="me-2"
                  />
                  Laptop Cleaning (Internal/External)
                ...
                <label className="d-flex align-items-center mb-3">
                  <input
                    ...
                    onChange={() =>
                      handleCategoryChange("Dust and Heat Management")
                    }
                    className="me-2"
                  />
                  Dust and Heat Management
                ...
                <label className="d-flex align-items-center mb-3">
                  <input
                    ...
                    onChange={() =>
                      handleCategoryChange("Data Migration Services")
                    }
                    className="me-2"
                  />
                  Data Migration Services
                ...
                <label className="d-flex align-items-center mb-3">
                  <input
                    ...
                    onChange={() =>
                      handleCategoryChange("Computer Recycling")
                    }
                    className="me-2"
                  />
                  Computer Recycling
